...
<style>
	body{
		height: 100vh;
        width: 100vw;
		background-image: url('lib/trainBack.jpg');
...
<script type="text/javascript">
  ...
  imgArray[0]="lib/tra1.jpg";
  imgArray[1]="lib/tra2.jpg";
  imgArray[2]="lib/tra3.jpg";
  imgArray[3]="lib/tra4.jpg";
  imgArray[4]="lib/tra5.jpg";
  var num= 0;
...
<body onload="showImage()">
	...
	var i_iwContent = '<div style="padding:5px;"><h3>인천역</h3><p><a href=\'https://www.airport.kr/ap/ko/index.do#\'>https://www.airport.kr/ap/ko/index.do#</a></div>';
	    i_iwRemoveable = true;
	var g_iwContent = '<div style="padding:5px;"><h3>김포역</h3><p><a href=\'https://www.airport.co.kr/gimpo/index.do\'>https://www.airport.co.kr/gimpo/index.do</a></div>';
	    g_iwRemoveable = true;
	var j_iwContent = '<div style="padding:5px;"><h3>제주역</h3><p><a href=\'https://www.airport.co.kr/jeju/index.do\'>https://www.airport.co.kr/jeju/index.do</a></div>';
	    j_iwRemoveable = true;
	var h_iwContent = '<div style="padding:5px;"><h3>김해역</h3><p><a href=\'https://www.airport.co.kr/gimhae/index.do\'>https://www.airport.co.kr/gimhae/index.do</a></div>';
	    h_iwRemoveable = true;
	var c_iwContent = '<div style="padding:5px;"><h3>청주역</h3><p><a href=\'https://www.airport.co.kr/cheongju/index.do\'>https://www.airport.co.kr/cheongju/index.do</a></div>';
	    c_iwRemoveable = true;
	var d_iwContent = '<div style="padding:5px;"><h3>대구역</h3><p><a href=\'https://www.airport.co.kr/daegu/index.do\'>https://www.airport.co.kr/daegu/index.do</a></div>';
	    d_iwRemoveable = true;
	var y_iwContent = '<div style="padding:5px;"><h3>양양역</h3><p><a href=\'https://www.airport.co.kr/yangyang/index.do\'>https://www.airport.co.kr/yangyang/index.do</a></div>';
	    y_iwRemoveable = true;
	...
	<!-- 광고 -->
 	...
 	<!-- 공항선택 -->
 	<div id="select">
 	<label id="searchLbl">기차역 검색 : </label>
 	<select id="airport" onchange="panTo(this.value);">
 		<option value="i">인천역</option>
 		<option value="g">김포역</option>
 		<option value="j">제주역</option>
 		<option value="h">김해역</option>
 		<option value="c">청주역</option>
 		<option value="d">대구역</option>
 		<option value="y">양양역</option>
 	</select>
